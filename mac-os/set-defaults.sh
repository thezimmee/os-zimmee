...
function update_computer_name () {
	ask $title "HostName:" hostname
	ask $title "ComputerName:" computername
	ask $title "LocalHostName:" localhostname
	sudo scutil --set HostName $hostname
	sudo scutil --set ComputerName $computername
	sudo scutil --set LocalHostName $localhostname
	log_computer_name
}
function log_computer_name () {
	log "HostName: ${BLUE}${host_name}${END_COLOR}, ComputerName: ${BLUE}${computer_name}${END_COLOR}, LocalHostName: ${BLUE}${localhost_name}${END_COLOR}"
}
log_computer_name
can_continue 'Update computer name?' && update_computer_name
...
# done
log $title "Config complete. Note that some changes may require a logout/restart to take effect." success